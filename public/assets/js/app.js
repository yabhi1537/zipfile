...
document.addEventListener('DOMContentLoaded', function () {
	var togglePasswordElements = document.getElementsByClassName('toggle-password');
	var inputElement = document.getElementsByClassName('pass-input')[0];

	if (togglePasswordElements.length > 0 && inputElement) {
		for (var i = 0; i < togglePasswordElements.length; i++) {
			togglePasswordElements[i].addEventListener('click', function () {
				togglePassword(this, inputElement);
			});
		}
	}
});
function togglePassword(toggleButton, inputField) {
	toggleButton.classList.toggle('feather-eye-off');
	toggleButton.classList.toggle('feather-eye');
...
document.addEventListener('DOMContentLoaded', function () {
	var confirmPasswordElements = document.getElementsByClassName('confirm-password');
	var inputElement = document.getElementsByClassName('pass-input-confirm')[0];

	if (confirmPasswordElements.length > 0 && inputElement) {
		for (var i = 0; i < confirmPasswordElements.length; i++) {
			confirmPasswordElements[i].addEventListener('click', function () {
				toggleConfirmPassword(this, inputElement);
			});
		}
	}
});

function toggleConfirmPassword(confirmButton, inputField) {
	confirmButton.classList.toggle('feather-eye-off');
	confirmButton.classList.toggle('feather-eye');
	if (inputField.getAttribute('type') === 'password') {
		inputField.setAttribute('type', 'text');
	} else {
		inputField.setAttribute('type', 'password');
