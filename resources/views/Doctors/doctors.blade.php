                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive">
                                <table class="table border-0 custom-table comman-table datatable mb-0">
                                    ...
                                    <tbody>
                                        @php
                                            $json = file_get_contents(public_path('../public/assets/json/doctors.json'));
                                        ...
                                        @foreach ($doctors as $doctor)
                                            <tr>
                                                ...
                                                <td class="profile-image"><a href="{{ url('profile') }}"><img width="28"
                                                            height="28"
                                                            src="{{ URL::asset('/assets/img/profiles/' . $doctor['Image']) }}"
                                                ...
                                                <td class="text-end">
                                                    <div class="dropdown dropdown-action">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-end">
                                                            <a class="dropdown-item" href="{{ url('edit-doctor') }}"><i
