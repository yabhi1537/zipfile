                        ...
                        <div class="card-body p-4">
                            <div class="table-responsive">
                                <table class="table custom-table comman-table mb-0 datatable">
                                    ...
                                    <tbody>
                                        @php
                                            $json = file_get_contents(public_path('../public/assets/json/invoices-recurring.json'));
                                        ...
                                        @foreach ($invoices as $invoice)
                                            <tr>
                                                ...
                                                <td>{{ $invoice['Lastinvoice'] }}</td>
                                                <td>{{ $invoice['Nextinvoice'] }}</td>
                                                <td>{{ $invoice['Frequency'] }}</td>
                                                <td><span class="{{ $invoice['Class'] }}">{{ $invoice['Status'] }}</span></td>
                                                <td class="text-end">
