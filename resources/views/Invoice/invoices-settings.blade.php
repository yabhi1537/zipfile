                        ...
                        <ul>
                            <li class="nav-item">
                                <a href="{{ url('invoices-settings') }}" class="nav-link active">
                                    <i class="fa fa-cog me-2" aria-hidden="true"></i><span>General Settings</span>
                                </a>
                            </li>
                            <li class="nav-item">
                ...
                <div class="col-xl-9 col-md-8">
                    <div class="card invoices-settings-card">
                        ...
                        <div class="card-body">
                            ...
                            <!-- Form -->
                            <form action="javascript:;" class="invoices-settings-form">
                                <div class="row align-items-center form-group">
                                    <label for="name" class="col-sm-3 col-form-label input-label">Invoice Status</label>
                                    <div class="col-sm-9">
                                        <label class="custom_check">
                                            <input type="checkbox" name="invoice">
                                            <span class="checkmark"></span> Change invoice status to paid after an order is
                                            complete
                                        </label>
                                    </div>
                                </div>
                                ...
                                <div class="row align-items-center form-group">
                                    <label for="phone" class="col-sm-3 col-form-label input-label">Invoice number starts
                                        with</label>
                                    <div class="col-sm-9">
