                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 col-md-6 col-xl-6">
                                        <div class="form-group local-forms calendar-icon">
                                            ...
                                            <input class="form-control datetimepicker" type="text" value="24-11-2023">
                                        </div>
                                    </div>
                                    <div class="col-12 col-md-6 col-xl-6">
                                    ...
                                    <div class="col-12 col-md-6 col-xl-4">
                                        <div class="form-group local-forms">
                                            ...
                                            @livewire('select-patient-department')
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12 col-md-6 col-xl-3">
                                        <div class="form-group local-forms">
                                            ...
                                            @livewire('select-patient-city')
                                        </div>
                                    </div>
                                    <div class="col-12 col-md-6 col-xl-3">
                                        <div class="form-group local-forms">
                                            <label>Country <span class="login-danger">*</span></label>
                                            @livewire('select-patient-country')
                                        </div>
                                    </div>
                                    <div class="col-12 col-md-6 col-xl-3">
                                        <div class="form-group local-forms">
                                            <label>State/Province <span class="login-danger">*</span></label>
                                            @livewire('select-patient-state')
                                        </div>
                                    </div>
                                    <div class="col-12 col-md-6 col-xl-3">
                                        <div class="form-group local-forms">
