                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 col-md-6 col-xl-6">
                                        <div class="form-group local-forms cal-icon">
                                            ...
                                            <input class="form-control datetimepicker" type="text" value="01.05.2023">
                                        </div>
                                    </div>
                                    <div class="col-12 col-md-6 col-xl-6">
                                        <div class="form-group local-forms cal-icon">
                                            <label>Due Date <span class="login-danger">*</span></label>
                                            <input class="form-control datetimepicker" type="text" value="04.05.2023">
                                        </div>
                                    </div>
                                    <div class="col-12 col-md-6 col-xl-6">
                                        <div class="form-group local-forms">
                                            ...
                                            <table class="table border-0 custom-table invoices-table">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input class="form-control" type="text"
                                                                style="min-width:150px" value="Full body checkup">
                                                        </td>
                                                        <td>
                                                            <input class="form-control" type="text"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input class="form-control" type="text"
                                                                style="min-width:150px" value="Blood Test">
                                                        </td>
                                                        <td>
                                                            <input class="form-control" type="text"
                                                                style="min-width:150px"
