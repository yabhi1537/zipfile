        ...
        <div class="card">
            <div class="card-body">
                <div class="heading-detail ">
                    ...
                    <p>Hello I am Cristina Groves a Gynaecologist in Sanjivni Hospital Surat. I love
            ...
            <div class="card-body">
                ...
                <div class="personal-activity">
                    <div class="personal-icons status-green">
                        <img src="{{ URL::asset('/assets/img/icons/medal-02.svg') }}"
                            alt="">
                    </div>
                    <div class="views-personal">
                        <h4>Certified</h4>
                ...
                <div class="personal-activity mb-0">
                    <div class="personal-icons status-orange">
                        <img src="{{ URL::asset('/assets/img/icons/medal-03.svg') }}"
                            alt="">
                    </div>
                    <div class="views-personal">
